                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1 class="col-lg-4" style="padding:0px;">Expense List</h1>
                                ...
                                @can('superAdmin')
                                    <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;"
                                        data-toggle="modal" data-target="#PrimaryModalalert"> Add Expense
                                    </button>
                                @endcan
                            </div>
                        </div>
                        ...
                        <div id="PrimaryModalalert" class="modal modal-adminpro-general default-popup-PrimaryModal fade"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('Expense.Expense_List') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="modal-header header-color-modal bg-color-1">
                                            <h4 class="modal-title"> Expense List nformation</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        <select name="expense_for" class="form-control" required>
                                                            <option value="">Select Expense For</option>
                                                            @foreach ($agent as $data)
                                                                <option value="{{ $data->name }}">{{ $data->area }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                        ...
                        <div id="EditModal" class="modal modal-adminpro-general default-popup-PrimaryModal fade"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('Expense.expense_list_update') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        <select name="Expense_type" class="form-control expense-type"
                                                            required>
                                                            @foreach ($expense_type as $item)
                                                                <option value="{{ $item->name }}">{{ $item->name }}
                                                                </option>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        <select name="expense_for" class="form-control expense-for"
                                                            required>
                                                            @foreach ($agent as $data)
                                                                <option value="{{ $data->name }}">{{ $data->area }}
                                                                </option>
                                        ...
                                        @foreach ($list as $data)
                                            <tr>
                                                ...
                                                <td class="datatable-ct">
                                                    ...
                                                    href="{{ route('Expense.expense_destroy', ['id' => $data->id]) }}"
    ...
    <script>
        $(document).ready(function() {
            $('.ediT').on('click', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('Expense.expense_list_edit') }}",
                    data: {
                        id: id
                    },
                    success: function(data) {
                        ...
                        $('.expense-type').val(data[0]['expense_type']);
                        $('.expense-for').val(data[0]['expense_for']);
