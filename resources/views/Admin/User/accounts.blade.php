                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">Accounts List</h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;" 
                                data-toggle="modal" data-target="#PrimaryModalalert">Register Accounts
                            </button>
                            @endcan
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Register Accounts Information</h4>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input id="email" type="email" name="email"
                                                    ...
                                                    autocomplete="email" placeholder="Accounts Email">
                                                @error('email')
