                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Product<span class="table-project-n"></span> Table
                            </h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;" 
                                data-toggle="modal" data-target="#PrimaryModalalert">Add Product
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">
                                                    Unit Price <span class="table-project-n">*</span>
                                                </label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <input type="number" name="unit_price" 
                                                    placeholder="Taka" class="form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">
                                                    Quantity <span class="table-project-n">*</span>
                                                </label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">
                                                    Weight <span class="table-project-n">*</span>
                                                </label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <select name="weight" class="form-control" required>
                                                    <option value="">Select Weight</option>
                                                    <option value="0">500 gm</option>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <input type="number" class="quantity form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <select class="weight form-control" required>
                                                    <option value="">Select Weight</option>
                                                    <option value="0">500 gm</option>
                                                    <option value="1">1 kg</option>
                                                    <option value="2">2 kg</option>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="cat_name" data-editable="false">Category</th>
                                        <th data-field="unit_price" data-editable="false">Unit Price</th>
                                        <th data-field="quantity" data-editable="false">Quantity</th>
                                        <th data-field="weight" data-editable="false">Weight</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->quantity }}</td>
                                        <td>
                                            @if ($data->weight == 0)    500 gm
                                            @elseif ($data->weight == 1)    1 kg
                                            @elseif ($data->weight == 2)    2 kg
                                            @elseif ($data->weight == 3)    3 kg
                                            @endif
                                        </td>
