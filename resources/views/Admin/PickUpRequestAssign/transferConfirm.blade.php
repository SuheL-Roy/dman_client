                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Order List <small> ( Transfer Confirm ) </small>
                            </h1>
                            ...
                            <form action="{{ route('order.transfer.confirm') }}" method="POST">
                                {{ csrf_field() }}
                            ...
                            <a class="btn btn-warning col-lg-2" href="{{ route('order.transfer_index') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" 
                                                href="{{ route('order.transfer.remove',['id'=>$data->id]) }}"
                                                onclick="return confirm('You want to Remove Order from Transfer ??');">
