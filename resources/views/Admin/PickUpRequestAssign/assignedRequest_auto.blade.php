                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1 class="col-lg-5" style="padding: 0px;">Auto Pick Up Order List <small> </small></h1>
                                ...
                                <div class="col-lg-6">
                                    <form class="" method="post" action="{{ route('request.assign.auto.list') }}">
                                        @csrf

                                        <div class="col-lg-4">
                                            <select name="merchant_id" class="form-control status" required>
                                                <option value="">---select Merchant ---</option>
                                                  @foreach ($merchants as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $selectedMerchant == $data->id ? 'Selected' : '' }}>
                                                        {{ $data->merchantname }}</option>
                                                @endforeach
                        ...
                        <form action="{{ route('request.assign.auto.collect.all') }}" method="GET">
                            @csrf
...
<tr>
                                                    ...
                                                    <td class="datatable-ct">
                                                        ...
                                                        <a href="{{ route('request.assign.auto.collect', ['id' => $data->tracking_id]) }}"
