...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        ...
                        <form class="" method="post" action="{{ route('delivery.assign.confirm_scan') }}">
                            @csrf
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            @if (session('key'))
                                                @foreach (Session::get('key') as $item => $details)
                                                    <tr>
    ...
    <script>
        function scan() {
            ...
            $.ajax({
                url: '{{ route('delivery.assign.scan_search') }}',
                type: 'POST',
                data: {
                    'name': query,
