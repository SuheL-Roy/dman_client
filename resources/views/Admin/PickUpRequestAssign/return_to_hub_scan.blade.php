...
@section('content')
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h5 class="col-lg-3" style="padding:0px;">
                                    Rteurn to transfer to Hub By Scan
                                </h5>
                                ...
                                <form class="" method="get" action="{{ route('admin.return.to.hub_index_scan') }}">
                                    @csrf
                        ...
                        <form class="" method="post" action="{{ route('admin.return.to.store_scan') }}">
                            @csrf
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($order as $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data->hub }}</td>
                                                    <td>{{ $data->status }}</td>
                                                    <td> <a href="{{ route('admin.return.to.removes', ['id' => $data->tracking_id]) }}"
                                                            class="btn"
    ...
    <script>
        function scan() {
            ...
            $.ajax({
                url: '{{ route('admin.return.to.hub_index_scan_store') }}',
                type: 'POST',
                data: {
                    'name': query,
