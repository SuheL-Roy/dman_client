                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4" style="padding:0px;">
                                Order List <small> ( Delivery Assign Confoirmation ) </small>
                            </h1>
                            ...
                            <form action="{{ route('delivery.assign.confirm') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="col-lg-2">
                            ...
                            <a class="btn btn-warning col-lg-1" href="{{ route('delivery.assign.index') }}"
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->id }}</td>
                                       {{--  <td>{{ $data->name }}</td> --}}
                                       <td>{{ $data->attributes->customer_name }}</td>
                                       <td>{{ $data->attributes->customer_phone }}</td>
                                       <td>{{ $data->attributes->customer_address }}</td>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" 
                                                href="{{ route('delivery.assign.remove',['id'=>$data->id]) }}"
                                                onclick="return confirm('You want to Remove Assigned Delivery ??');">
