                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('accounts.payment.collect',['id'=>$data->tracking_id])}}" 
                                                class="btn btn-warning btn-xs" title="Payment Collect ??"
                                                onclick="return confirm('Are You Sure To Collect This Payment  ??')">
