...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1 class="col-lg-3" style="padding:0px;">
                                    Order List <small> ( In Destination Hub By Scan ) </small>
                                </h1>
                        ...
                        <form action="{{ route('order.destination.collect.all_scan') }}" method="GET">
                            @csrf
    ...
    <script>
        function scan() {
            ...
            $.ajax({
                url: '{{ route('order.destination_scan_store') }}',
                type: 'POST',
                data: {
                    'name': query,
