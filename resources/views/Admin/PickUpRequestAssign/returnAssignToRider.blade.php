            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <div class="container col-lg-2">
                                    <a target="blank__" href="{{ route('order.move.return.assign.list_scan') }}"
                                        type="btn" class="btn btn-success">Return Assign To Rider By Scan</a>
                                </div>
                        ...
                        <form class="" method="post" action="{{ route('admin.move.return.assign.load') }}">
                            @csrf
                        ...
                        ?>
                        <form class="" method="POST" action="{{ route('admin.move.return.assign.store') }}">
                            @csrf
                            ...
                            @else
                                <div class="col-lg-1">
                                    <a href="{{ route('admin.move.return.assign.print', $latestId1) }}" type="btn"
                                        class="btn btn-success">print
                                    </a>
                                </div>
                            @endif
