            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1 class="col-lg-3" style="padding:0px;">
                                    Order List <small> ( Delivery Processing for Branch ) </small>
                                </h1>
                                ...
                                <form class="" method="post" action="{{ route('delivery.assign.branch') }}">
                                    @csrf

                                    <div class="col-lg-2">

                                    <select name="hub" class="form-control hub" required>
                                            <option value="">Select Hub</option>
                                            @foreach ($hub_list as $value)
                                                <option value="{{ $value->uid }}"
                                                    {{ $hub == $value->uid ? 'selected' : '' }}>
                                                    {{ $value->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <form class="" method="post" action="{{ route('delivery.assign.branch.confirm') }}">
                            @csrf

                            <input type="hidden" name="sel_hub" value="{{$hub}}"/>
                            <div class="col-lg-2">
