            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h4 class="col-lg-3" style="padding:0px;">
                                    Transfer to Hub <small> (Assign Confoirmation) </small>
                                </h4>
                               
                                <div class="container col-lg-1">
                                    <a target="blank__" href="{{ route('order.transfer_index_scan') }}" type="btn"
                                ...
                                <form class="" method="post" action="{{ route('order.transfer') }}">
                                    @csrf
                        ...
                        <form class="" method="post" action="{{ route('order.transfer.agent.store') }}">
                            @csrf
