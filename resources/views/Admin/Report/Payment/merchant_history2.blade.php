@extends('Master.main')
@section('title')
    Payment History Report Date Wise
@endsection
@section('content')
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4" style="padding:0px;">
                                Payment History Report <small>(Date Wise)</small>
                            </h1>                            
                            <form action="{{ route('order.report.merchant.history2') }}" method="get">
                                @csrf
                                <div class="col-lg-3">
                                    <div class="row">
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <tbody>
                                    <?php $i = 1;?>
                                    @foreach ($m_payments as $m_payment)
                                    <tr>                                       
                                        <td>{{ $i++ }}.</td>
                                        <td>{{ $m_payment->date }}</td>
                                        <td>{{ $m_payment->tracking_id }}</td>
                                        <td>{{ $m_payment->order_id }}</td>
                                        <td>{{ $m_payment->collection }}</td>
                                        <td>{{ $m_payment->merchant_pay }}</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    @endforeach                                 
