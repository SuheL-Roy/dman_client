...
<head>
    <meta charset="UTF-8">
    <title>Hub Transaction History Report</title>
        ...
        <div class="row">
            <div>
                <div class="container-1 mt-5" style="text-align: center; margin-top: 15px;">
                    ...
                    <h4>Mobile: {{ $branch->mobile ?? 'NULL' }}</h4> --}}
                    <h4>Invoice No: {{ $invid ?? 'NULL' }}</h4>
                ...
                <div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="8" style="text-align:right; "><b>Total Collected Amount:</b>
                                    &nbsp;</td>
