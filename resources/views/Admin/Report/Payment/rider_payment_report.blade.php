                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($payments as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('order.report.agent.transaction.payment.show', $data->id) }}"
                                                        class="btn btn-primary btn-xs">
                                                        <i class="fa fa-eye"></i>
                                                        show
                                                    </a>
                                                    <a href="{{ route('order.report.agent.transaction.payment.print', $data->id) }}"
