                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-5" style="padding:0px;">
                                Payment Adjustment Report <small>(Date Wise)</small>
                            </h1>
                            <form action="{{ route('order.report.datewise.adjustment.print') }}" 
                            ...
                            <form action="{{ route('order.report.datewise.adjustment') }}" method="get">
                                @csrf
                                <div class="col-lg-3">
                                    <div class="row">
