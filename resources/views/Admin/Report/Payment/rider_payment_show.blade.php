                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-6" style="padding:0px;">
                                Collect amount by <small> ( {{ $rider->name }} ) </small>
                            </h1>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" 
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="s_name" data-editable="false">Merchant Phone</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="11" style="text-align:right; "><b>Total Collected  Amount:</b> &nbsp;</td>
                                            {{--  <td> &nbsp;&nbsp; {{ $tCol }}</td>  --}}
