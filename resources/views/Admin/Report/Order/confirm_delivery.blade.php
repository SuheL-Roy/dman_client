@extends('Master.main')
@section('title')
    Confirm Delivery Report Date Wise
@endsection
@section('content')
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4" style="padding:0px;">
                                Confirm Delivery Report <small>( Date Wise )</small>
                            </h1>
                            <form action="{{ route('order.report.confirm.delivery') }}" method="get">
                                {{ csrf_field() }}
                                <div class="col-lg-3">
                                    <div class="row">
                                        <div class="col-lg-4">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>{{ $Qty }}</td>
                                        <td style="text-align:center;">Total Collection :</td>
                                        <td>{{ $Total }}</td>
                                    </tr>
                                </tfoot>
                            </table>
