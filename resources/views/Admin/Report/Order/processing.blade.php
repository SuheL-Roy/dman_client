@extends('Master.main')
@section('title')
    Order Report Payment Processing
@endsection
@section('content')
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Order Report <small>( Payment Processing )</small>
                            </h1>
                            <form action="{{ route('order.report.processing') }}" method="get">
                                @csrf
                                <div class="col-lg-4">
                                    <div class="row">
                                        <div class="col-lg-3">
                            ...
                            <form action="{{ route('order.report.processing.print') }}" 
