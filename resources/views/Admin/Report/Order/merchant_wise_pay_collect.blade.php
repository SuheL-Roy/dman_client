@extends('Master.main')
@section('title')
    Order Report Merchant Wise Payment Collect
@endsection
@section('content')
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Order Report <br><small>( Merchant Wise Payment Collect )</small>
                            </h1>
                            <form action="{{ route('order.report.merchant.wise.pay.collect.print') }}" 
                            ...
                            <form action="{{ route('order.report.merchant.wise.pay.collect') }}" method="get">
                                @csrf
