@extends('Master.main')
@section('title')
    Order Report Merchant Wise Payment Complete
@endsection
@section('content')
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Order Report <br><small>( Merchant Wise Payment Complete )</small>
                            </h1>
                            <form action="{{ route('order.report.merchant.wise.pay.complete.print') }}" 
                            ...
                            <form action="{{ route('order.report.merchant.wise.pay.complete') }}" method="get">
                                @csrf
