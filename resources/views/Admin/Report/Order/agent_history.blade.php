                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <form action="{{ route('order.report.admin.agent.history') }}" method="GET">
                                    @csrf
                                    <div class="col-lg-2">
                                        <select name="agent" class="selectpicker form-control" required title="Select Hub"
                                ...
                                <form action="{{ route('order.report.merchant_wise') }}" method="get" class="col-lg-1"
                                    ...
                                    @csrf
                                    <input type="hidden" name="merchant" value="{{ $agent }}" />
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="sfs" data-editable="false">C. Name</th>
                                            <th data-field="rsdfg" data-editable="false">C. Mobile</th>
                                            <th data-field="ret" data-editable="false">Destination</th>
                                            <th data-field="wer" data-editable="false">C. Address</th>
