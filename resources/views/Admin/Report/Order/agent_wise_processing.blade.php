@extends('Master.main')
@section('title')
    Order Report Agent Wise Payment Processing
@endsection
@section('content')
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Order Report <br><small>( Agent Wise Payment Processing )</small>
                            </h1>
                            <form action="{{ route('order.report.agent.wise.processing.print') }}" method="get" 
                            ...
                            <form action="{{ route('order.report.agent.wise.processing') }}" method="get">
                                @csrf
