...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <li>
                <a href="{{ route('admin.panel.manager.dashboards') }}">
            ...
            {{-- </li>
            <li>
                <a href="{{ route('order.list.index') }}">
                    <i class="fa fa-list"></i>
                    <span class="link_name">All Parcel List</span>
                </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('order.lists') }}">All Parcel List</a></li>
                    <li><a href="{{ route('order.backup_create') }}">Add Parcel</a></li>
                    <li><a href="{{ route('csv-file-upload') }}">Bulk Import</a></li>
                </ul>
            </li>
            <li>
                <a href="{{ route('accounts.merchant.paymentinfo') }}">
                    <i class="fa fa-credit-card-alt"></i>
                    <span class="link_name">Payment Update</span>
                </a>

            </li>
            <li>
                <a href="{{ route('order.collection.hub') }}">
            ...
            <li>
                <a href="{{ route('order.transfer_index') }}">
                    <i class="fa fa-exchange"></i>
                    <span class="link_name">Transfer To Hub</span>
                </a>

            </li>
            <li>
                <a href="{{ route('admin.return.to.hub_index') }}">
                    <i class="fa fa-exchange"></i>
                    <span class="link_name">Return To Hub</span>
                </a>

            </li>
            <li>
                <a href="{{ route('admin.bypass.to.return.index') }}">
                    <i class="fa fa-exchange"></i>
                    <span class="link_name">Return To Bypass</span>
                </a>

            </li>
            <li>
                <a href="{{ route('agent.collect.index') }}">
                    <i class="fa fa-credit-card-alt"></i>
                    <span class="link_name">Hub Payment</span>
                </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a class="link_name" href="#">Payment</< /a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a class="link_name" href="#">Ticket</< /a>
                    </li>
                    <li><a href="{{ route('complain.payment.request') }}">Payment Requests</a></li>
                    <li><a href="{{ route('complain.index') }}">Reveived Tickets</a></li>
                    <li><a href="{{ route('complain.report.statuswise') }}">Filtering Tickets</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a class="link_name" href="#">Report</< /a>
                    </li>
                    <li><a href="{{ route('order.collection') }}">Merchant Payment History</a></li>
                    <li><a href="{{ route('order.collection') }}">Transaction History</a></li>
                    <li><a href="{{ route('order.collection') }}">Rider History</a></li>
                    <li><a href="{{ route('order.collection') }}">Rider Collect History</a></li>
                    <li><a href="{{ route('order.collection') }}">Transfer History</a></li>
                    <li><a href="{{ route('order.collection') }}">Merchant History</a></li>
                    <li><a href="{{ route('order.collection') }}">Hub History</a></li>
                    <li><a href="{{ route('order.collection') }}">Merchant Wise</a></li>
                    <li><a href="{{ route('order.collection') }}">Merchant Adjustment</a></li>
                    <li><a href="{{ route('order.collection') }}">Advance Payment</a></li>
                    <li><a href="{{ route('order.collection') }}">Return History</a></li>
                </ul>
            </li> --}}
            ...
            <li>
                <div class="profile-details">
                    ...
                    <div class="name-job">
                        <div class="profile_name">Courier Lab</div>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <h2 class="mb-0 text-center">{{ $tOrderPlaced }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $oneHourPickup }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center"> {{ $regularPickup }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $regularDelivery }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $urgentDelivery }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $tOrdercancel }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $pCl }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-list"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_OrderPlaced }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_PickupDone }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_oneHourPickup }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_regularPickup }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_regularDelivery }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_urgentDelivery }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $t_tOrdercancel }}</h2>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-truck"></i>
                                <div>
                                    <h2 class="mb-0 text-center"> {{ $t_Pickupcancel }}</h2>
                    ...
                    <div class="d-grid" style="place-items: center">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="my-0">Total Unsuccess Ratio</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card py-3">
                    <div class="d-grid" style="place-items: center">
                        <div class="d-flex align-items-center gap-2">
                            <i style="color: #0bbce5; font-size: 39px" class="fa fa-shopping-cart"></i>
                            <div>
                                <h2 class="mb-0 text-center">{{ $total_delivery_return_ratio }}%</h2>
                                <p class="my-0">Total Return Ratio</p>
                            </div>
                        </div>
                    </div>
                </div>
