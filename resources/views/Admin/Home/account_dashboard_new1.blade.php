...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <li>
                <a href="{{ route('accounts.dashboards') }}">
            ...
            <li>
                <a href="{{ route('agent.collect.index') }}">
                    <i class="fa fa-credit-card-alt"></i>
                    <Hub class="link_name">Hub Payment</span>
                </a>

            </li>

            <li>
                <a href="{{ route('merchant.payment.collect.index') }}">
                    <i class="fa fa-credit-card-alt"></i>
                    <Merchant class="link_name">Merchant Payment</span>
                </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('order.report.admin.transfer.history') }}">Transaction History</a></li>
                    ...
                    <li><a href="{{ route('order.status.merchant') }}">Merchant Wise</a></li>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <h2 class="mb-0 text-center">{{ $processing }}</h2>
                                    <p class="my-0" style="text-align: center;">Today Invoice Processing</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <h2 class="mb-0 text-center">{{ $complete }}</h2>
                                    <p class="my-0">Today Processing Amount</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-credit-card-alt"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $collect }}</h2>
                                    <p class="my-0">Today Paid Amount</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-credit-card-alt"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $tprocessing }}</h2>
                                    <p class="my-0" style="text-align: center;">Total Invoice Processing</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-credit-card-alt"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $tcomplete }}</h2>
                                    <p class="my-0">Total Processing Amount</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card py-3">
                        <div class="d-grid" style="place-items: center">
                            <div class="d-flex align-items-center gap-2">
                                <i style="color: #0bbce5; font-size: 39px" class="fa fa-credit-card-alt"></i>
                                <div>
                                    <h2 class="mb-0 text-center">{{ $tcollect }}</h2>
