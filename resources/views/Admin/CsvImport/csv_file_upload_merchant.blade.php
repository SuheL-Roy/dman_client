                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <h3 style="background: rgb(72, 188, 220); padding: 8px; text-align: center">Upload Regular csv file</h3>




                            <form action="{{ route('file-import-store-regular-merchants') }}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        <div style="" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <form action="{{ route('file-import-store-express-merchants') }}" method="post" enctype="multipart/form-data">
                                @csrf
