...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h4 class="col-lg-3" style="padding:0px;">
                                    Transfer to Fulfillment By Scan <small> </small>
                                </h4>
                                <div class="col-lg-3">
                        ...
                        <form class="" method="get" action="{{ route('order.transfer.head_office_scan') }}">
                            @csrf
                        ...
                        <form class="" method="post" action="{{ route('order.transfer.headoffice_store_scan') }}">
                            @csrf
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($order as $data)
                                                <tr>
                                                    ...
                                                    @endif --}}
                                                    <td>
                                                    <a href="{{ route('admin.return.to.removes', ['id' => $data->tracking_id]) }}"
                                                        class="btn btn-danger"
                                                        onclick="return confirm('Are You Sure To Remove ??')"><i class="fa fa-trash"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
    ...
    <script>
        function scan() {
            ...
            $.ajax({
                url: '{{ route('order.transfer.head_office_scan_store') }}',
                type: 'POST',
                data: {
                    'name': query,
