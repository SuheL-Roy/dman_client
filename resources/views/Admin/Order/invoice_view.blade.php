...
<body>
        ...
        <div class="row">
            <div class="col-8 offset-1">
                <div class="container-1 mt-2">
                    <a href=""><img style="width:450px;height:80px;" src="{{ asset($company->logo) }}"></a>

                    <h4 class="mt-1">Address: {{ $company->address }}</h4>
                    <h4>Mobile: {{ $company->mobile }}</h4>
                    <h5 class="mt-2"><u> Order Details ({{ $data->tracking_id }})</u></h5>
    ...
    <script data-cfasync="false" src="https://amvines.com/backend/js/email-decode.min.js"></script>
    <script>
