...

                    {
                        ...
                        "render": function(data, type, row, meta) {
                            ...
                            if ((row['status'] == "Order Placed") || (row['status'] ==
                                ...
                                var action = '<a class="btn" title="PickUp Cancel ??" onclick=' +
                                    "'" +
                                    'return confirm("Are You Sure You Want To Cancel This ??")' +
                                    "'" + ' href={{ route('request.assign.cancel') }}' + '?id=' +
                                    data + '>' +
                            ...
                            action =
                                '<form action={{ route('order.confirm_edit') }} method="post"><input type="hidden" name="_token" value="{{ csrf_token() }}"><input type="hidden" name="fromdate" value="' +
                                fromdate + '" /><input type="hidden" name="todate" value="' +
                                todate + '"/><input type="hidden" name="id" value="' + data +
                                '" /><a ><a class="btn"><button type="submit" class="btn btn-info"><i class="fa fa-edit"></i></button></a></form>' +
                                '<a class="btn" target="_blank" href={{ route('order.collect.print') }}' +
                                '?id=' + data + '>' +
                                '<button class="btn btn-success"><i class="fa fa-print"></i></button>' +
                                '</a>' +
                                '<form action={{ route('request.assign.delete.order.admin') }} method="post"><input type="hidden" name="_token" value="{{ csrf_token() }}"><input type="hidden" name="fromdate" value="' +
                                fromdate + '" /><input type="hidden" name="todate" value="' +
                                todate + '"/><input type="hidden" name="id" value="' + data +
                                '" /><a ><a class="btn"><button onclick="return confirm(' + "'" +
                                'Are You Sure You Want To Cancel This ??' + "'" +
                                ')" type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button></a></form>' +
                                action;
...

                        {
                            ...
                            "render": function(data, type, row, meta) {
                                ...
                                if ((row['status'] == "Order Placed") || (row['status'] ==
                                        "Assigned Pickup Rider")) {
                                    var action =
                                        '<a class="btn" title="PickUp Cancel ??" onclick=' +
                                        "'" +
                                        'return confirm("Are You Sure You Want To Cancel This ??")' +
                                        "'" +
                                ...
                                action =
                                    ...
                                    todate + '"/><input type="hidden" name="id" value="' +
                                    data +
                                    '" /><a ><a class="btn"><button type="submit" class="btn btn-info"><i class="fa fa-edit"></i></button></a></form>' +
                                    '<a class="btn" target="_blank" href={{ route('order.collect.print') }}' +
                                    '?id=' + data + '>' +
