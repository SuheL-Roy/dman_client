            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        ...
                        <div class="clearfix">
                            <form action="{{ route('order.create_order_list') }}" method="GET">
                                @csrf
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="c_address34" data-editable="false">Delivery Charge</th>
                                                ...
                                                @if (Auth::user()->role == 1)
                                                    <th data-field="action" data-editable="false">Order Export All Action
                                                    </th>
                                                @else
