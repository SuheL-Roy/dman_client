            ...
            <div class="row">
                <div class="col-8 offset-1">
                    <div class="container-1 mt-5">
                        <img style="width:450px;height:80px;" src="{{ asset($company->logo) }}">

                        <h4 class="mt-1">Address: {{ $company->address }}</h4>
                        <h4>Mobile: {{ $company->mobile }}</h4>
                        <h5 class="mt-5"><u> Order Details ({{ $data->tracking_id }})</u></h5>

                        <a href="{{ route('order.invoice.view', ['id' => $data->tracking_id]) }}"> <i
                                class="fa fa-print"></i>
                        </a>
                            ...
                            <tbody>
                             ...
                             {{--   <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->type == 'Urgent' ? 'Express' : 'Regular' }}</td>
                                  <th class="">Weight</th>
                                    <td>{{ $data->weight }}</td>
