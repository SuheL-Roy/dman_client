...
@section('content')
                    ...
                    <div class="container" style="background: white; margin-top:15px; border-radius:10px;width:1190px;">
                        <div class="information-wrapper my-3">
                            <div class="col-left">
                                ...
                                <form class="payment-form" action="{{ route('order.admin.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="d-flex gap-2 my-1 mt-0">
                                        <div class="w-100">
                                            ...
                                            <select name="user_id" id="merchant" class="form-control" required>
                                    ...
                                    <div class="d-flex gap-2 my-1">
                                        <div class="w-100">
                                            <label for="" class="form-label d-block">Select District</label>
                                            {{-- <select onchange="fetch_subcategory_option()" name="hub_id" id="district_id"
                                                class="js-example-basic-single form-control select2" required>
                                    ...
                                    <div class="justify-end" style="display: flex; gap:10px;">
                                        ...
                                        <div class="d-flex my-1 justify-end">
                                            <a target="__blank" href="{{ route('order.latest_collect_print') }}"
                                                type="btn" class="btn btn-primary">Print</a>
    ...
    <script>
        $(document).on('change', '#merchant', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('merchant_wise_district') }}",
                data: {
                    id: target_value
                },
                success: function(data) {
                    ...
                    $.each(data, function(index, option) {
                        $('#district_id').append('<option value="' + option.d_id +
                            '">' +
                            option.d_name +
                            '</option>');
                    });
                   ...
                   $('#subcategory_option').append('<option value="">Select Area</option>');
                    demo();
    ...
    <script>
        function demo() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                    // document.getElementById("delivery-charge").innerHTML = "TK.";
                    // document.getElementById("cod").innerHTML = "Tk.";
                    // document.getElementById("subtotal").innerHTML = "Tk.";
                    // document.getElementById("total").innerHTML = "Tk." ;
    ...
    <script>
        ...
        function fetch_subcategory_option() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "{{ route('fetch.subcategory.value.new') }}",
                data: {
                    id: id,
                    merchant_id: $('.merchant_id').val(),
                },
