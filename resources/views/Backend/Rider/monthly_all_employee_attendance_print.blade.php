...
<body onload="window.print();window.history.back()">
    <div style="text-align:center;">
        ...
        @endforeach
        <h4><u>All Employee Monthly Attendance Report</u></h4>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th data-field="sl">Designation</th>
                @php
        ...
        <tbody>
            ...
            @if (isset($monthly_attendance_all))
                @foreach ($monthly_attendance_all as $key => $item)
                    <tr>
