...
<body onload="window.print();window.history.back()">
    <div style="text-align:center;">
        ...
        @endforeach
        <h4><u>Employee Attendance Report</u></h4>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th data-field="sl">Employee No</th>
                <th data-field="rider" data-editable="false">Employee Name</th>
                <th data-field="shop_name" data-editable="false">Designation</th>
                <th data-field="customer_name" data-editable="false">Mobile</th>
                <th data-field="customer_phone" data-editable="false">Branch</th>
                <th data-field="customer_address" data-editable="false">Status</th>
                <th data-field="note" data-editable="false">Intime</th>
                <th data-field="status" data-editable="false">OutTime</th>
