...
<body onload="window.print();window.history.back()">
    <div style="text-align:center;">
        ...
        @endforeach
        <h4><u>Employee Monthly Attendance Report</u></h4>
        <h5> Employee Name : {{ $employee }}</h5>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th data-field="sl">Employee Type</th>
                @php
                ...
                <tr>
                    ...
                    @for ($i = 1; $i < $today->daysInMonth + 1; ++$i)
                        ...
                        <td>
                            ...
                            <div style="text-align: center; font-weight: bold;" class="form-check form-check-inline ">
