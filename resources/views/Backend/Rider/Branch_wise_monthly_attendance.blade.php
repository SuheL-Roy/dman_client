            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h6 class="col-lg-2" style="padding:0px; margin-right:20px;">
                                    Mothly Branch wise Attendance
                                </h6>

                                <form action="{{ route('rider.attendance.branch.wise.monthly.attendance') }}" method="get">
                                    @csrf
                        ...
                        <p>
                        <form action="{{ route('rider.attendance.branch.wise.monthly.attendance.print') }}" method="get"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($branch_wise_monthly_attendance as $key => $item)
                                            <tr>
                                                ...
                                                <td class="rider-name">{{ $item->area }}</td>
