...
<body onload="window.print();">
    ...
    <h4 style="text-align: center; margin-top: 15px;">Phone: {{ $company->mobile ?? 'NULL' }}</h4>
    <h4 style="text-align: center; margin-top: 15px;">Merchant invoice: {{ $invoice_ids ?? 'NULL' }}</h4>
    <h4 style="text-align: center; margin-top: 15px;">Date: {{ $merchantpay->updated_at ?? 'NULL' }}
    </h4>
    <h4 style="text-align: center; margin-top: 15px;">Merchant name: {{ $merchant_name->business_name ?? 'NULL' }}</h4>
    </div>
