                                        ...
                                        @foreach ($payments as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('order.return.admin.merchant.confirm.dfgmndfkg', $data->id) }}"
                                                        class="btn btn-info btn-xs">
                                                    ...
                                                    {{-- <a href="{{ route('order.return.admin.merchant.confirm', $data->id) }}"
                                                        onclick="return confirm('Are You Sure You received this return ??');"
