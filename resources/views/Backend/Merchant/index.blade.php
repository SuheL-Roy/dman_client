                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="invoicaa" data-editable="false">M.Name</th>
                                            <th data-field="werwe" data-editable="false">M.Phone</th>
                                            <th data-field="werwetwe" data-editable="false">M.Address</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($payments as $paymentinfo)
                                            <tr>
                                                ...
                                                <td>{{ $paymentinfo->merchant->name ?? '' }}</td>
                                                <td>{{ $paymentinfo->merchant->mobile ?? '' }}</td>
                                                <td>{{ $paymentinfo->merchant->address ?? '' }}</td>
                                                {{-- <td>{{ $paymentinfo->shop_name }}</td>
                                                <td>{{ $paymentinfo->shop_phone }}</td> --}}
                                                {{-- <td>{{ $paymentinfo->shop_address }}</td> --}}
                                                <td>{{ $paymentinfo->creator->name }}</td>
                                                <td>{{ $paymentinfo->updator->name ?? 'Not Yet' }}</td>

                                                <td>
                                                    <a href="{{ route('order.report.admin.rider.return.show', $paymentinfo->id) }}"
