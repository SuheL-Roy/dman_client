                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="create_date" data-editable="false">Invoice Date(From -To)</th>
                                            <th data-field="invoice" data-editable="false">Invoice No</th>
                                            <th data-field="invoicaa" data-editable="false">Rider Name</th>
                                            {{-- <th data-field="werwe" data-editable="false">Rider Phone</th> --}}
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <a class="btn btn-success"
                                                             href="{{ route('rider.payment.collect.print',['invoice_id'=>$paymentinfo->invoice_id]) }}"  target="_blank">
                                                            Print
                                                        </a>
