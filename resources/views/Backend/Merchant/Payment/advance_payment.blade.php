                        ...
                        <div class="sparkline13-hd">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    ...
                                    <form action="{{ route('merchant.advance.payment') }}" method="GET">
                                        @csrf
                                                    ...
                                                    <select name="business_name" title="Merchant" class="form-control"
                                                        ...
                                                        @foreach ($merchants as $merchant)
                                                            <option value="{{ $merchant->business_name }}"
                                                                ...
                                                                {{ $merchant->business_name }}-(M{{$merchant->id}})
                                                            </option>
                                                        @endforeach
                                        ...
                                        <button  type="submit"class="col-lg-1  btn btn-primary btn-sm Primary">Load</button>
                                    </form>

                                    <form action="{{ route('merchant.advance.payment.print') }}" method="get"
