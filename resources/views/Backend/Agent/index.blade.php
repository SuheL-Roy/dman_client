                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-5" style="padding:0px;">
                                Hub Collection <small></small>
                            </h1>


                            <form action="{{ route('agent.collect.index') }}" method="get">
                                @csrf
                                <div class="col-lg-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="date" name="fromdate" required value="{{ $fromdate }}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $payment->createby->name ?? '' }}</td>
                                        <td>{{ $payment->updateby->name ?? 'Not yet' }}</td>
                                        <td>{{ $payment->t_collect }}</td>

                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-info" href="{{ route('agent.collect.show', $payment->id) }}" class="btn ">
                                                    View
                                                </a>

                                                <a class="btn btn-success" href="{{ route('agent.collect.agent.collected', $payment->id) }}" class="btn " onclick="return confirm('Are You Sure ??')">
