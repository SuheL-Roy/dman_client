...
class MerchantHistoryPaymentController extends Controller
{
    ...
    public function merchent_pay_info_print(Request $request)
    {
        ...
        $merchantPayments = MerchantPaymentDetail::where('invoice_id', $merchantpay->invoice_id)
            ...
            ->whereIn('order_status_histories.status', ['Successfully Delivered', 'Pathao Order Delivered', 'Redx Cancel Order', 'Redex Order Delivered', 'Pathao Cancel Order', 'Cancel Order', 'Partially Delivered', 'Exchange Delivered', 'Reschedule Order'])
