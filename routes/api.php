...
Route::get('hub-wise-dist-list', [ShopController::class, 'hub_wise_dist_list'])->middleware('auth:api');
Route::get('dist-wise-area', [ShopController::class, 'dist_wise_area'])->middleware('auth:api');
