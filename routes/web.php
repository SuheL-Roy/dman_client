...
//bulk csv import
Route::get('/csv-file-upload-merchants', [CsvController::class, 'file_upload_merchants'])->middleware('auth')->name('csv-file-upload-merchants');
Route::post('/csv-data-regular-merchants', [CsvController::class, 'import_regular_merchants'])->name('file-import-store-regular-merchants');
Route::post('/csv-data-express-merchants', [CsvController::class, 'import_express_merchants'])->name('file-import-store-express-merchants');
...
Route::post('/csv-data-submit-regular-merchants', [CsvController::class, 'submit_regular_merchants'])->middleware('auth')->name('file-data-submit-regular-merchant');
Route::post('/csv-data-submit-express-merchants', [CsvController::class, 'submit_express_merchants'])->middleware('auth')->name('file-data-submit-express-merchant');
...
Route::get('/merchant-wise-district', [AjaxDataController::class, 'merchant_wise_district'])->name('merchant_wise_district');
...
Route::get('/fetch/subcategory/value/edit', [AjaxDataController::class, 'fetch_subcategory_value_edit'])->name('fetch_subcategory_value_edit');

Route::get('/fetch/subcategory/value-new', [AjaxDataController::class, 'fetch_subcategory_value_new'])->name('fetch.subcategory.value.new');
...
Route::post('area_data_merchants', [AjaxDataController::class, 'area_data_merchant'])->name('ajaxdata.area.merchants');
